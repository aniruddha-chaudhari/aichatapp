        ...
        <View
          ...
          >
            <View className='flex-row items-center'>
              ...
              <View>
                <Text
                        className="text-[#242424] text-base font-[sora-semi] pb-1 ml-3"
                  >Cash/Wallet
                </Text>
                <Text
                        className="text-[#C67C4E] text-sm font-[sora-semi] ml-3"
          ...
          <TouchableOpacity 
                className={`${totalPrice=== 0 ? 'bg-[#EDEDED]' : 'bg-[#C67C4E]' }  2-full rounded-2xl items-center justify-center mt-6 py-3`}
